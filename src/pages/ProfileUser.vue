  ...
  >
    ...
    <section class="mb-8">
      ...
      <form @submit.prevent="handleUpdatePassword">
        <div class="mb-4">
          <label class="block mb-1" for="currentPassword">Current Password</label>
          <input
      ...
      <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
        ...
        <router-link to="/recover" class="text-blue-500 dark:text-blue-400 hover:underline">
          Recover Account
        </router-link>
      </p>
    ...
    <section class="mb-8">
      ...
      <p class="mb-4 text-gray-700 dark:text-gray-300">
        Proceed with caution. Make sure you have taken a backup of your account in case you ever
        need to get access to your data. We will completely wipe your data. There is no way to
      ...
      >
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg w-96">
          <h3 class="text-xl font-semibold mb-4 text-red-500">Confirm Account Deletion</h3>
          <p class="mb-4">
...
import { auth } from '../boot/firebase' // Ensure this path is correct
