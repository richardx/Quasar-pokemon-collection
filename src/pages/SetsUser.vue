<template>
  <div class="container mx-auto p-4 bg-white dark:bg-gray-900">
    <h1 class="text-2xl font-bold mb-4 text-gray-800 dark:text-white">Pokémon Sets</h1>
    <div v-for="(sets, series) in groupedSets" :key="series" class="mb-6">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        >
          <img :src="set.images.logo" alt="Set Logo" class="w-32 h-32 object-contain mb-2" />
