<template>
  <div class="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
    <div class="bg-white dark:bg-gray-800 p-6 rounded shadow-md w-full max-w-md">
      <h1 class="text-2xl font-bold mb-4 text-center text-gray-800 dark:text-gray-100">Login</h1>
      <form @submit.prevent="login" class="space-y-4">
        ...
        <div>
          <label class="block text-gray-700 dark:text-gray-300">Adgangskode</label>
          <input
            v-model="password"
            type="password"
        ...
        <p class="text-center text-gray-700 dark:text-gray-300">
          ...
          <router-link to="/registerUser" class="text-blue-500 dark:text-blue-400 hover:underline">
            Opret en her
          </router-link>
        </p>
      </form>
