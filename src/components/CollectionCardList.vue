<template>
  <div>
    ...
    <div v-if="!cards || cards.length === 0" class="text-center text-gray-500 dark:text-gray-400">
      No cards available
    </div>
    <!-- Kort Grid -->
      ...
      >
        ...
        <div class="p-4 flex flex-col flex-grow">
          ...
          <div class="flex items-center space-x-2 mb-2">
            ...
            <span class="text-gray-800 dark:text-white">{{ card.quantity }}</span>
            <button
          ...
          <p class="text-gray-800 dark:text-gray-200 mb-4">
            <strong>Price:</strong>
            {{ card.marketPrice ? `$${(card.marketPrice * card.quantity).toFixed(2)}` : 'N/A' }}
          </p>
          <!-- Handling Knapper -->
