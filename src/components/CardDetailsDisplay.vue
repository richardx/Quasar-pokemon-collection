  ...
  >
    <div class="flex flex-col md:flex-row">
      ...
      <div class="flex-1">
        ...
        <p class="mb-2"><strong>Evolves From:</strong> {{ apiDetails.evolvesFrom || 'N/A' }}</p>
        <p class="mb-2">
          <strong>Set:</strong>
        ...
        <div class="mb-2">
          ...
          <ul v-if="apiDetails.attacks && apiDetails.attacks.length" class="list-disc list-inside">
...
const marketPrice = computed(() => {
  ...
  } else if (apiDetails.value.tcgplayer?.prices?.normal?.market !== undefined) {
